...
var file_Orders_proto_rawDesc = []byte{
	...
	,
...
var file_Orders_proto_goTypes = []interface{}{
	...
	(*OrderMain)(nil),    // 2: service.OrderMain
}
var file_Orders_proto_depIdxs = []int32{
	2, // 0: service.OrderRequest.order_main:type_name -> service.OrderMain
	1, // 1: service.OrderService.GetOderStatus:input_type -> service.OrderRequest
	0, // 2: service.OrderService.GetOderStatus:output_type -> service.orderStatus
...
type OrderServiceClient interface {
	GetOderStatus(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderStatus, error)
}
...
func (c *orderServiceClient) GetOderStatus(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderStatus, error) {
	out := new(OrderStatus)
...
type OrderServiceServer interface {
	GetOderStatus(context.Context, *OrderRequest) (*OrderStatus, error)
}
...
func (*UnimplementedOrderServiceServer) GetOderStatus(context.Context, *OrderRequest) (*OrderStatus, error) {
...
func _OrderService_GetOderStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetOderStatus(ctx, req.(*OrderRequest))
	}
